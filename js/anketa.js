// ============================================
// АНКЕТЫ + ЛАЙКИ - Экран управления v7.5
// ============================================

console.log('🔥 ANKETA.JS ЗАГРУЖЕН (v7.5)');
...
const Anketa = {
    ...
    injectStyles() {
        ...
        style.textContent = `
            ...
            /* ============================= */
            /* STACK EFFECT — ЧЁТНЫЕ СДВИНУТЫ */
            /* ============================= */

            .anketa-card:nth-child(even) {
                transform: translateY(2px) scale(0.995);
                opacity: 0.98;
            }

            /* ============================= */
            /* LIGHT SWEEP — БЛИК ПРИ ТАПЕ   */
            /* ============================= */
            ...
            .anketa-card.filled {
                ...
                box-shadow: 
                    ...
                    var(--card-glow, 0 0 20px rgba(255,85,0,0.06));
            }
            ...
            .anketa-card.filled {
                animation: 
                    cardSlideUp 0.5s cubic-bezier(0.22, 0.61, 0.36, 1) forwards,
                    floatSoft 6s ease-in-out 0.5s infinite;
            }
            ...
            .anketa-card:hover .anketa-watermark svg {
                transform: scale(1.15) rotate(2deg);
            }

            .anketa-card:active .anketa-watermark svg {
...
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('anketaScreen')) {
        console.log('✅ anketaScreen найден, запускаю v7.5');
        Anketa.init();
    }
});
...
console.log('✅ Anketa v7.5 готов — stack + float + sweep + parallax + physics');
