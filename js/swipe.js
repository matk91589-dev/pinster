...
class SwipeRenderer {
    ...
    .swipe-card.back-1 {
        transform: translate3d(0,11px,0) scale(0.95);
        opacity: 0.48;
        z-index: 1;
        filter: blur(1px);
    }
    ...
    .swipe-badge.like {
        right: 24px;
        border: 2px solid #34FF8A;
        color: #34FF8A;
        background: rgba(52,255,138,0.15);
    ...
    .swipe-dock-btn:active {
        transform: scale(0.85);
        opacity: 1;
    }
    .swipe-dock-btn.nope-btn {
        color: rgba(255,255,255,0.5);
    }
    .swipe-dock-btn.nope-btn:active {
        color: #FF4D6D;
    }
    ...
    .swipe-dock-btn.decision-active {
        opacity: 1 !important;
    ...
    .swipe-pulse.fire {
        animation: pulseFire 0.5s ease-out forwards;
    }
    @keyframes pulseFire {
        0% {
    ...
    .swipe-card.wiggle {
        animation: idleWiggle 1.5s ease-in-out 2;
    }
